...
---@field create_scaffolding fun(self: Project.Utils.Path, callback: (fun(err: string|nil, success: boolean|nil))?)
...
function M:create_scaffolding(callback)
    uv.fs_mkdir(self.projectpath, 448, callback ~= nil and callback or nil)
end
